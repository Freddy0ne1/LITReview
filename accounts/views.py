        ...
        if username_to_follow:
            try:
                ...
                # Validation : vérifier si un blocage existe
                    ...
                    messages.error(request, "Vous ne pouvez pas suivre cet utilisateur en raison d'un blocage.")
...
def unblock_user(request, user_id):
    ...
    if block:
        ...
        messages.warning(request, f"Vous n'aviez pas bloqué {user_to_unblock.username}.")
